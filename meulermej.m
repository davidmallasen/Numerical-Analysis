...
% Explicit Enhanced Euler method.
%
% La funcion meulermej resuelve un problema de valor inicial de la forma
% x'=f(t,x) en [t0,T]
% x(t0)=x0,
% con x0 en R^n, mediante el metodo de Euler mejorado (explicito).
%
% ENTRADA:
